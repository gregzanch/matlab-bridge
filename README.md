...
sed -i.mybak "s/\([\/\"]\)(ryansonshine)/$GITHUB_USER/g; s/typescript-npm-package-template\|my-package-name/$REPO_NAME/g; s/Greg Zanchelli/$FULL_NAME/g" package.json package-lock.json README.md
rm *.mybak
```
